    ...
    <div className="max-w-md mx-auto mt-10 bg-white shadow-md rounded-lg p-8">
      ...
      <div className="mt-4">
        <button
          ...
          className="w-full flex items-center cursor-pointer justify-center gap-2 border border-gray-300 text-sm text-gray-700 py-2 rounded-md hover:bg-gray-100 transition"
        >
          <img
